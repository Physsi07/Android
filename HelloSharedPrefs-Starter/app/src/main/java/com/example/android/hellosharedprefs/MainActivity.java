...
public class MainActivity extends AppCompatActivity {
    ...
    // String
    private String SHARED_PREF_FILE = "com.example.andfroid.hellosharedprefs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize references views, color
        ...
        // GETTING THE VALUES AND THE KEY FROM MY VARIABLES, GETTING FROM FILE
...
//        mShowCountTextView.setBackgroundColor(mColor);
        ...
        // Restore the saved state. See onSaveIns[];'ytanceState() for what gets saved.
